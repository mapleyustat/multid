 ...
 */
    ...
    /* Call code from fe-handling-example.c, which is included below. */
    setup_signal_handler();
}

/*   Title:  Floating-point exception handling example
    Author:  David N. Williams
      File:  fe-handling-example.c
...
To compile it under Linux, execute:
  ...
  cc -lm -o fe-handling fe-handling-example.c
*/

#if 0 /* Commented out by B. Plohr */
#ifdef __linux__
/* BEGIN quote
...
#include <fenv.h>
#endif /* Commented out by B. Plohr */
